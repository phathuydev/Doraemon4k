<div class="row m-0 mt-3 p-1 rounded-2">
    ...
    <?php foreach ($getAllComment as $item) { ?>
      <div class="d-flex flex-start mb-2">
        ...
        <div class="flex-grow-1 flex-shrink-1">
                ...
                <div class="modal-body">
                  <div class="text-end">
                    <form action="<?= $current_url ?>" method="post">
                      <textarea name="content_reply" class="w-100 rounded-2 p-2" id="__contentComment14" maxlength="30" placeholder="Thể hiện ý kiến của bạn, tối đa 30 ký tự" required></textarea>
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="text-end">
                    <form action="<?= $current_url ?>" method="post">
                      <textarea name="content_reply" class="w-100 rounded-2 p-2" id="__contentComment15" maxlength="30" placeholder="Thể hiện ý kiến của bạn, tối đa 30 ký tự" required></textarea>
                      <input type="hidden" name="parent_id" value="<?= $item['comment_id'] ?>">
                      <button type="submit" name="reply" class="btn btn-dark text-white p-1 border-0 mt-2 rounded-1">Phản hồi</button>
                    </form>
                  </div>
          ...
          ?>
            <div class="d-flex flex-start mt-2 ms-2">
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="text-end">
                          <form action="<?= $current_url ?>" method="post">
                            <textarea name="content_reply" class="w-100 rounded-2 p-2" id="__contentComment17" maxlength="30" placeholder="Thể hiện ý kiến của bạn, tối đa 30 ký tự" required></textarea>
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="text-end">
                          <form action="<?= $current_url ?>" method="post">
                            <textarea name="content_reply" class="w-100 rounded-2 p-2" id="__contentComment18" maxlength="30" placeholder="Thể hiện ý kiến của bạn, tối đa 30 ký tự" required></textarea>
                            <input type="hidden" name="parent_id" value="<?= $data['parent_id'] ?>">
                            <input type="hidden" name="grandparent_id" value="<?= $data['comment_id'] ?>">
                            <button type="submit" name="reply" class="btn btn-dark text-white p-1 border-0 mt-2 rounded-1">Phản hồi</button>
                          </form>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="text-end">
                                <form action="<?= $current_url ?>" method="post">
                                  <textarea name="content_reply" class="w-100 rounded-2 p-2" id="__contentComment20" maxlength="30" placeholder="Thể hiện ý kiến của bạn, tối đa 30 ký tự" required></textarea>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="text-end">
                                <form action="<?= $current_url ?>" method="post">
                                  <textarea name="content_reply" class="w-100 rounded-2 p-2" id="__contentComment21" maxlength="30" placeholder="Thể hiện ý kiến của bạn, tối đa 30 ký tự" required></textarea>
                                  <input type="hidden" name="parent_id" value="<?= $value['parent_id'] ?>">
                                  <input type="hidden" name="grandparent_id" value="<?= $value['grandParent_id'] ?>">
                                  <input type="hidden" name="user_id_reply" value="<?= $value['user_id'] ?>">
                                  <button type="submit" name="reply" class="btn btn-dark text-white p-1 border-0 mt-2 rounded-1">Phản hồi</button>
