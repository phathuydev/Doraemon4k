          ...
          <table class="table table-striped">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  <td><?= $offset++ ?></td>
                  <td><img src="http://img.ophim12.cc/uploads/movies/<?= $poster_url ?>" width="120" alt=""></td>
                  <td>
                  ...
                  <td>
                    <?php if (empty($getVideoSlug)) : ?>
                      <form method="post" action="/ApiManage?pages=<?= $_GET['pages'] ?>">
                        ...
                        <input type="hidden" name="image" value="http://img.ophim12.cc/uploads/movies/<?= $poster_url ?>">
